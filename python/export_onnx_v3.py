...
def export_speed_aware_to_onnx(
    ...
    from train_classification_v2 import SpeedAwareDualViewNet, CLASS_NAMES
...
if __name__ == "__main__":
    ...
    v2_checkpoint = checkpoint_dir / "driving_classifier_v2.pth"

    if v2_checkpoint.exists():
        print("=== Speed-Aware Model Export ===")
        output_path = unity_assets / "driving_classifier_v2.onnx"
